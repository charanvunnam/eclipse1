...
public class demoextentproject {
	...
	{
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Users\\hp\\Desktop\\ec-new\\demoextent\\target\\extentreports\\extent.html");
   ...
   public void githubTesting() throws InterruptedException{
	 ...
	 driver.close();
	 driver.quit();
	 test.info("successfully completed the testcase1 in aws EC2 by extent email notification");
	 extent.flush();
